...
REM =============================================================
REM  Run Medium Load Chaos benchmark for 4 ALB strategies
REM  Robust version:
...
set "TEST_PLAN=D:\eclipse-workspace\adaptive-load-balancer-parent\jmeter\02_medium_dependency_slowdown_mixed_0600_tst.jmx"
set "RESULT_BASE=D:\Downloads\apache-jmeter-5.6.3\bin\ALB_Test\results\02_medium_dependency_slowdown_mixed_0600_tst"
