...
REM =============================================================
REM  Run Low Load benchmark for 4 ALB strategies
REM  Robust version:
...
set "TEST_PLAN=D:\eclipse-workspace\adaptive-load-balancer-parent\jmeter\01_low_baseline_mixed_0300_nochaos_tst.jmx"
set "RESULT_BASE=D:\Downloads\apache-jmeter-5.6.3\bin\ALB_Test\results\01_low_baseline_mixed_0300_nochaos_tst"
