...
set "TEST_PLAN=D:\eclipse-workspace\adaptive-load-balancer-parent\scripts_run_jmeter\04_stress_recovery_mixed_1200_to_0600_nochaos_tst.jmx"
set "RESULT_BASE=D:\Downloads\apache-jmeter-5.6.3\bin\ALB_Test\results\04_stress_recovery_mixed_1200_to_0600_nochaos_tst"
