...
set "TEST_PLAN=D:\eclipse-workspace\adaptive-load-balancer-parent\jmeter\03_high_dependency_slowdown_mixed_0900_tst.jmx"
set "RESULT_BASE=D:\Downloads\apache-jmeter-5.6.3\bin\ALB_Test\results\03_high_dependency_slowdown_mixed_0900_tst"
