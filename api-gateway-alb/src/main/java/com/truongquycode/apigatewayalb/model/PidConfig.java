...
public class PidConfig {
    private double kp = 3.0;    // Tăng từ 1.5 -> 2.5 để phản ứng P gắt hơn
    private double ki = 0.3;    // Tích lũy có trọng lượng hơn 0.15 -> 0.2
    ...
    private double lambda = 2.0; // Penalty weight tăng lên 0.8 -> 3
